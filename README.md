...
## Guide
In the folder [code/](code/) you can find the main [jupyter notebook](code/CognitiveRouting.ipynb) of the project. Run to reproduce the main results. Other notebooks were used to train and infer steering vectors.
